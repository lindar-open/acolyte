...
class MapsAcolyte {
    companion object {
        ...
        */
         ...
         * */
        @JvmStatic
        fun <K, V> defaultIfNull(map: Map<K, V>?): Map<K, V> {
            return map ?: HashMap()
        }

        @JvmStatic
        fun <K, V> defaultIfNull(map: Map<K, V>?, defaultVal: Map<K, V>): Map<K, V> {
            return map ?: defaultVal
        }

        @JvmStatic
        fun <K, V> defaultIfEmpty(map: Map<K, V>?, defaultVal: Map<K, V>): Map<K, V> {
